...
Use the project's documented Git conventions. Lean Delivery does not impose a branch, reviewer, push, or author-identity policy; it must not silently relax a project-specific one.
